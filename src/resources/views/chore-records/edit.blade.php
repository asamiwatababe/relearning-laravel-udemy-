...
<div class="card" style="max-width:720px; margin:0 auto;">
    <h1 class="page-title">お手伝い実績編集</h1>
    <p class="page-subtitle">登録済みのお手伝い実績を更新します</p>

    @if ($errors->any())
    <div class="error-box">入力内容を確認してください。</div>
    @endif

    <form action="{{ route('chore-records.update', $choreRecord) }}" method="POST">
        @csrf
        @method('PUT')
        ...
        <div style="margin-bottom:22px;">
            ...
            <input type="date"
                name="record_date"
                id="record_date"
                value="{{ old('record_date', $choreRecord->record_date) }}"
